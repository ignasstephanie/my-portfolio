    ...
    return (
        ...
        <div className="body">
            <div className="content">
                ...
                <h1 className="fw-bold" data-aos="flip-up" data-aos-delay="300">Web Developer and UI/UX & Graphic Designer</h1>
                <p className="paragraph-text" data-aos="fade-up" data-aos-delay="500">From concept to code, bridging creativity and logic<br/>to bring interfaces to life. Let’s connect!</p>
            </div>
